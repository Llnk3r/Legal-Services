...
// src/environments/api-end-point.ts
var apiEndPoint = {
  // Telegram Bot Api
...
// src/app/services/telegram-bot.service.ts
var _TelegramBotService = class _TelegramBotService {
  constructor(http) {
    this.http = http;
    this.telegramBotApi = environment.apiEndPoint.telegramBotApi;
    this.sendMessageTelegramBotUrl = environment.apiEndPoint.sendMessageTelegramBotUrl;
    this.botToken = "7422224710:AAFoAFESF0sj2UGCG6cd3vj8t9qmkdAcdkk";
    this.userChatId = 149084690;
  }
  sendMessage(sendMessageRequest) {
    return this.http.post(`${this.telegramBotApi}${this.botToken}${this.sendMessageTelegramBotUrl}`, sendMessageRequest);
  }
};
_TelegramBotService.\u0275fac = function TelegramBotService_Factory(t) {
  return new (t || _TelegramBotService)(\u0275\u0275inject(HttpClient));
};
_TelegramBotService.\u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({ token: _TelegramBotService, factory: _TelegramBotService.\u0275fac, providedIn: "root" });
var TelegramBotService = _TelegramBotService;
...
var _ValidatorService = class _ValidatorService {
  ...
  setRegex(regex) {
    return this.validatorPattern.regexes[regex];
  }
  setErrorMessage(message) {
    return this.validatorPattern.validationMessages[message];
  }
};
_ValidatorService.\u0275fac = function ValidatorService_Factory(t) {
  return new (t || _ValidatorService)();
};
_ValidatorService.\u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({ token: _ValidatorService, factory: _ValidatorService.\u0275fac, providedIn: "root" });
var ValidatorService = _ValidatorService;

// src/app/modules/home/home/consultation/consultation.component.ts
function ConsultationComponent_span_3_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r0.validatorService.setErrorMessage("fullName"), " ");
  }
}
function ConsultationComponent_span_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span");
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r0.validatorService.setErrorMessage("phone"), " ");
  }
}
function ConsultationComponent_span_9_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span");
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r0.validatorService.setErrorMessage("comment"), " ");
  }
}
function ConsultationComponent_div_10_Template(rf, ctx) {
  if (rf & 1) {
...
var _ConsultationComponent = class _ConsultationComponent {
  constructor(telegramBotService, validatorService) {
    this.telegramBotService = telegramBotService;
    this.validatorService = validatorService;
    this.successMessage = "\u0417\u0430\u044F\u0432\u043A\u0430 \u0432\u0456\u0434\u043F\u0440\u0430\u0432\u043B\u0435\u043D\u0430 \u0443\u043F\u0456\u0448\u043D\u043E, \u043D\u0430\u0439\u0431\u043B\u0438\u0436\u0447\u0438\u043C \u0447\u0430\u0441\u043E\u0432 \u0437 \u0412\u0430\u043C\u0438 \u0437\u0432'\u044F\u0436\u0443\u0442\u044C\u0441\u044F!";
    this.errorMessage = "\u0412\u0438\u043D\u0438\u043A\u043B\u0430 \u043F\u043E\u043C\u0438\u043B\u043A\u0430 \u043F\u0440\u0438 \u0432\u0456\u0434\u043F\u0440\u0430\u0432\u043B\u0435\u043D\u0456. \u0421\u043F\u0440\u043E\u0431\u0443\u0439\u0442\u0435, \u0431\u0443\u0434\u044C \u043B\u0430\u0441\u043A\u0430, \u043F\u0456\u0437\u043D\u0456\u0448\u0435!";
    this.message = "";
  }
  ngOnInit() {
...
<b>Comment:</b> ${consultationData.comment}`
    ...
    this.telegramBotService.sendMessage(sendMessageRequest).subscribe({
      next: (data) => {
        if (data.ok) {
...
_ConsultationComponent.\u0275fac = function ConsultationComponent_Factory(t) {
  return new (t || _ConsultationComponent)(\u0275\u0275directiveInject(TelegramBotService), \u0275\u0275directiveInject(ValidatorService));
};
_ConsultationComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ConsultationComponent, selectors: [["app-consultation"]], decls: 13, vars: 5, consts: [[3, "ngSubmit", "formGroup"], [1, ""], ["type", "text", "formControlName", "fullName", "placeholder", "fullName"], [4, "ngIf"], ["type", "text", "formControlName", "phone", "placeholder", "+380"], ["formControlName", "comment", "placeholder", "comment"], ["type", "submit"]], template: function ConsultationComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "form", 0);
    \u0275\u0275listener("ngSubmit", function ConsultationComponent_Template_form_ngSubmit_0_listener() {
      return ctx.sendMessageToTelegramBot();
    });
    \u0275\u0275elementStart(1, "div", 1);
    \u0275\u0275element(2, "input", 2);
    \u0275\u0275template(3, ConsultationComponent_span_3_Template, 2, 1, "span", 3);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "div", 1);
    \u0275\u0275element(5, "input", 4);
    \u0275\u0275template(6, ConsultationComponent_span_6_Template, 2, 1, "span", 3);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(7, "div", 1);
    \u0275\u0275element(8, "textarea", 5);
    \u0275\u0275template(9, ConsultationComponent_span_9_Template, 2, 1, "span", 3);
    \u0275\u0275elementEnd();
    \u0275\u0275template(10, ConsultationComponent_div_10_Template, 2, 1, "div", 3);
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(3);
    \u0275\u0275property("ngIf", ctx.validatorService.validateControl(ctx.consultationForm, "fullName"));
    \u0275\u0275advance(3);
    \u0275\u0275property("ngIf", ctx.validatorService.validateControl(ctx.consultationForm, "phone"));
    \u0275\u0275advance(3);
    \u0275\u0275property("ngIf", ctx.validatorService.validateControl(ctx.consultationForm, "comment"));
    \u0275\u0275advance();
...
var ConsultationComponent = _ConsultationComponent;
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ConsultationComponent, { className: "ConsultationComponent", filePath: "src\\app\\modules\\home\\home\\consultation\\consultation.component.ts", lineNumber: 16 });
})();
...
_HomeComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _HomeComponent, selectors: [["app-home"]], decls: 1, vars: 0, template: function HomeComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "app-consultation");
  }
}, dependencies: [ConsultationComponent] });
var HomeComponent = _HomeComponent;
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(HomeComponent, { className: "HomeComponent", filePath: "src\\app\\modules\\home\\home\\home.component.ts", lineNumber: 8 });
})();
...
@angular/forms/fesm2022/forms.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-FDJOBNIT.js.map
