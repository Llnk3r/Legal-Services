...
TransferStateService.\u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({
...
IdleMonitorService.\u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({
...
var ScullyRoutesService = class {
  constructor(router, http) {
    ...
    this.allRoutes$ = this.refresh.pipe(
      ...
      filter((routes2) => Array.isArray(routes2)),
      map(this.cleanDups),
      shareReplay({
        refCount: false,
        bufferSize: 1
    ...
    this.topLevel$ = this.available$.pipe(map((routes2) => routes2.filter((r) => !r.route.slice(1).includes("/"))), shareReplay({
      refCount: false,
      bufferSize: 1
    }));
    this.reload();
  ...
  cleanDups(routes2) {
    ...
    routes2.forEach((r) => m.set(JSON.stringify(Object.assign(Object.assign({}, r), {
...
ScullyRoutesService.\u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({
...
var ScullyContentComponent = class {
  ...
  upgradeToRoutelink(elm) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const routes2 = yield this.routes;
      const href = elm.getAttribute("href");
      const lnk = basePathOnly(href.toLowerCase());
      const route = routes2.find((r) => basePathOnly(r.route.toLowerCase()) === lnk);
...
ScullyContentComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({
...
ScullyContentModule.\u0275mod = /* @__PURE__ */ \u0275\u0275defineNgModule({
  type: ScullyContentModule
});
ScullyContentModule.\u0275inj = /* @__PURE__ */ \u0275\u0275defineInjector({});
(() => {
...
ScullyLibModule.\u0275mod = /* @__PURE__ */ \u0275\u0275defineNgModule({
  type: ScullyLibModule
});
ScullyLibModule.\u0275inj = /* @__PURE__ */ \u0275\u0275defineInjector({
...
var routes = [
  {
    path: "",
    loadChildren: () => import("./chunk-FDJOBNIT.js").then((m) => m.HomeModule)
  },
  {
    path: "not-found",
    loadChildren: () => import("./chunk-UHEX5MRN.js").then((m) => m.Page404Module)
  },
  {
    path: "**",
...
_AppRoutingModule.\u0275inj = /* @__PURE__ */ \u0275\u0275defineInjector({ imports: [RouterModule.forRoot(routes, { scrollPositionRestoration: "enabled" }), RouterModule] });
...
_HeaderComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _HeaderComponent, selectors: [["app-header"]], decls: 2, vars: 0, template: function HeaderComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p");
    \u0275\u0275text(1, "header works!");
    \u0275\u0275elementEnd();
  }
} });
var HeaderComponent = _HeaderComponent;
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(HeaderComponent, { className: "HeaderComponent", filePath: "src\\app\\modules\\header\\header\\header.component.ts", lineNumber: 8 });
})();
...
_FooterComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _FooterComponent, selectors: [["app-footer"]], decls: 2, vars: 0, template: function FooterComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p");
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(FooterComponent, { className: "FooterComponent", filePath: "src\\app\\modules\\footer\\footer\\footer.component.ts", lineNumber: 8 });
})();

// src/app/app.component.ts
var _AppComponent = class _AppComponent {
  constructor() {
    this.title = "Legal-Services";
  }
};
...
_HeaderModule.\u0275mod = /* @__PURE__ */ \u0275\u0275defineNgModule({ type: _HeaderModule });
_HeaderModule.\u0275inj = /* @__PURE__ */ \u0275\u0275defineInjector({ imports: [CommonModule] });
...
_FooterModule.\u0275mod = /* @__PURE__ */ \u0275\u0275defineNgModule({ type: _FooterModule });
_FooterModule.\u0275inj = /* @__PURE__ */ \u0275\u0275defineInjector({ imports: [CommonModule] });
